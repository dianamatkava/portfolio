...
export default function HeaderNav() {
  return (
    <div className="w-full py-8 inline-flex justify-between items-center bg-black">
      ...
      <div
        className="w-fit mx-auto py-3 px-4 rounded-3xl outline outline-1 outline-neutral-800 inline-flex items-center gap-12"
        data-aos="fade-down"
      >
        <Logo />
      ...
      <div className="inline-flex items-center gap-3" data-aos="fade-down">
